...
export default function LiquidEther({
  ...
  this.renderer.domElement.style.position = 'absolute'; // ADD
  this.renderer.domElement.style.inset = '0';           // ADD
  this.renderer.domElement.style.zIndex = '0';          // ADD
  this.renderer.domElement.style.pointerEvents = 'none'; // ADD
